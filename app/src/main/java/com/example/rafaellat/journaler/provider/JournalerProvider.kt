package com.example.rafaellat.journaler.provider
...
class JournalerProvider : ContentProvider() {
    ...
    private val db: SQLiteDatabase by lazy { DbHelper(name, version).writableDatabase }
    ...
    companion object {
        ...
        val AUTHORITY = "com.example.rafaellat.journaler.provider"
        ...
        uri?.let {
            values?.let {
                ...
                if (!TextUtils.isEmpty(table)) {
                    ...
                    throw SQLException(
                        "Update failed, no table for uri : " + uri
                    )
                }
            }
        }
    ...
    override fun delete(
        ...
        uri?.let {
            ...
            if (!TextUtils.isEmpty(table)) {
                ...
                throw SQLException(
                    "Delete failed, no table for uri: "
                            + uri
                )
            }
        }
